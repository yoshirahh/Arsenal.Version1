<form class="form-horizontal" action="/scripts/eventsubmit.php" method="post" id="event-form">
  <fieldset>
    ...
    <h4 class="form-group" style="text-align: center;">You will receive an email with instructions for the audition within 48 hours.</h4>
...
$('#event-form').submit(function(event) {
	var formData = {
		...
		'p_namef': $('input[name=p-name-first-reg]').val(),
		'p_namel': $('input[name=p-name-last-reg]').val(),
		'birth'  : $('input[name=birthday-reg]').val(),
		'school' : $('input[name=school-reg]').val(),
		'email'  : $('input[name=email-reg]').val(),
		'p_email': $('input[name=p-email-reg]').val(),
